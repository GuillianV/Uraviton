...
public class CameraController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _objectToFollowRigidbody = objectToFollow.GetComponent<Rigidbody>();
        if (!_objectToFollowRigidbody)
        {
            Debug.LogError("Object need Rigidbody with velocity");
        }
    ...
    void FixedUpdate()
    {
        ...
        //Velocity
        Vector3 velocity = _objectToFollowRigidbody.velocity;
        ...
        if (velocity.magnitude > 0.1f)
        {
            ...
            float angle = Mathf.Atan2( velocity.z,velocity.x); // velocity.z, velocity.x
            ...
            Vector3 cameraDestination = new Vector3(objectPos.x - force.x,objectPos.y + heightDistanceFromObject, objectPos.z - force.z);
